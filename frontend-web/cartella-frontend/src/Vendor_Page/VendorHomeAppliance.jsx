...
const VendorHomeAppliance = () => {
  ...
  useEffect(() => {
    ...
    fetch(`https://it342-g5-cartella.onrender.com/api/products/vendor/${vendorId}/category/Home Appliances`, {
...
export default VendorHomeAppliance;
