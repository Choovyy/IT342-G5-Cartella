...
const VendorMenAccessories = () => {
  ...
  useEffect(() => {
    ...
    fetch(`https://it342-g5-cartella.onrender.com/api/products/vendor/${vendorId}/category/Men's Accessories`, {
    ...
    <Box sx={{ display: "flex", minHeight: "100vh" }}>
      ...
      >
        <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
          <Typography variant="h4">Men's Accessories</Typography>
          <Button
            variant="contained"
            sx={{
              width: 130,
...
export default VendorMenAccessories;
